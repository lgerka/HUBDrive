...
export function TopNav() {
    return (
        <header className="fixed top-0 w-full z-50 bg-[#f8f9fb]/80 dark:bg-[#191c1e]/80 backdrop-blur-xl shadow-[0px_12px_32px_rgba(25,28,30,0.04)]">
            <div className="flex items-center justify-between px-4 py-1.5 max-w-7xl mx-auto relative">
                <div 
                ...
                >
                    <Image src="/hub-drive-logo.png" alt="HUBDrive" width={96} height={21} className="object-contain" priority />
                </div>
