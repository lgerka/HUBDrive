 ...
 * задаётся в META_DEAL_VALUE_USD. Пока продаж мало, стоит осторожная оценка —
 * как только появится своя цифра, её надо поставить сюда: по ней Meta будет
 * искать людей, приносящих деньги, а не просто обращения.
 */
export const DEAL_VALUE_USD = Number(process.env.META_DEAL_VALUE_USD) || 1500;
